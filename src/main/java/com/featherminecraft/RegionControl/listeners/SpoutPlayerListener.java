...
public class SpoutPlayerListener implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        RCPlayer rcplayer = new PlayerUtils()
                .getRCPlayerFromBukkitPlayer(splayer);
    ...
    public void onRegionCapture(RegionCaptureEvent event) {
        ...
        for (RCPlayer player : playerList) {
            player.getSpoutClientLogic().updateRegion(
                    event.getCapturableRegion());
    ...
    public void onRegionCaptureStatusChange(RegionCaptureStatusChangeEvent event) {
        ...
        for (RCPlayer player : playerList) {
            player.getSpoutClientLogic().setRegionCaptureStatus(
                    event.getCaptureStatus());
        }
    }
    ...
    public void onSpoutcraftEnable(SpoutCraftEnableEvent event) {
        ...
        RCPlayer rcPlayer = new PlayerUtils()
                .getRCPlayerFromBukkitPlayer(splayer.getPlayer());
