...
public class PlayerListener implements Listener {
    ...
    public void onEntityDamage(EntityDamageByEntityEvent event) {
        ...
        if (playerdamager != null && damagedplayer != null) {
            ...
            Faction damagerfaction = playerutils
                    .getPlayerFaction(playerdamager);
            Faction damagedentityfaction = playerutils
                    .getPlayerFaction(damagedplayer);
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        CapturableRegion currentRegion = faction.getFactionSpawnRegion(player
                .getWorld());
    ...
    public void onPlayerQuit(PlayerQuitEvent event) {
        ...
        // RCPlayer object
        try {
            RCPlayer player = playerUtils.getRCPlayerFromBukkitPlayer(event
                    .getPlayer());
    ...
    public void onPlayerRespawn(PlayerRespawnEvent event) {
        ...
        if (respawnLocation != null) {
            ...
            event.setRespawnLocation(rcplayer.getFaction()
                    .getFactionSpawnRegion(player.getWorld()).getSpawnPoint()
                    .getLocation());
        }
