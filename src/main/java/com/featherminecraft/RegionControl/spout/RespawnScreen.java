...
public class RespawnScreen {
    ...
    public RespawnScreen(InGameHUD mainscreen,RCPlayer player)
    {
        ...
        redeployButton = (Button) new GenericButton("Respawn").setScale(1F).setWidth(170).setHeight(20).
                setMargin(0, 3).setFixed(true).setX(5).setY(60)
                .setAnchor(WidgetAnchor.CENTER_LEFT).setPriority(RenderPriority.Lowest);
        ...
        this.popup = (GenericPopup) new GenericPopup();
