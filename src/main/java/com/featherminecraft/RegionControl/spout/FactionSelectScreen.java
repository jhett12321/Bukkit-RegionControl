...
public class FactionSelectScreen
{
    public FactionSelectScreen(Player player)
    {
        ...
        // Color theReturned = new
        // Color(ServerLogic.factions.get("theReturned").getFactionColor().getRed(),ServerLogic.factions.get("elderTyrants").getFactionColor().getGreen(),ServerLogic.factions.get("elderTyrants").getFactionColor().getBlue());
